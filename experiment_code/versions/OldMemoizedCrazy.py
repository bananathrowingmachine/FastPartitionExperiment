...
Out of all the versions of partition, this was formerlt the one that is the most my own, as the crazy math is my own, 
while the general partition/subset sum algorithm itself is written by Jeff Erickson and then translated for this experiment.
