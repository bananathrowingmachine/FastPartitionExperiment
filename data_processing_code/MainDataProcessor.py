...
class MainDataProcessor:
    ...
    def appendData(self, results: ResultsWrapper) -> None:
        ...
        with pd.ExcelWriter(self.tablesDir / "output.xlsx", engine="xlsxwriter") as writer:
